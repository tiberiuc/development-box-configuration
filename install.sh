...
sudo apt-get -y install ruby rubygems puppet curl zsh mc git git-flow nodejs chef graphicsmagick php5-cli php5-fpm ctags php5-curl libimage-exiftool-perl optipng libjpeg-turbo-progs optipng ruby-dev libpcre3-dev cmake unzip nfs-common tig python-pip libssl-dev
